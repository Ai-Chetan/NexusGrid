"""
Django settings for NexusGrid project.
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "parthshikhare21@gmail.com"
EMAIL_HOST_PASSWORD = "tvuw bbpp prqx icml"  # Use an App Password, not your actual password
