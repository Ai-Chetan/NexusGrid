document.addEventListener('DOMContentLoaded', function() {
    ...
    function performSearch() {
        ...
        if (visibleCount === 0) {
            ...
            resultsCount.textContent = `Showing ${visibleCount} resource requests${visibleCount !== 1 ? 's' : ''}`;
        }
    }
    ...
    function resetFilters() {
        ...
        noResultsMessage.style.display = 'none';
        resultsCount.textContent = `Showing all resource requests (${faultCards.length})`;
    }
    ...
    submitFaultButton.addEventListener('click', function() {
        ...
        if (newFaultForm.checkValidity()) {
            ...
            // Update fault count
            resultsCount.textContent = `Showing all resource requests (${faultCards.length + 1})`;
